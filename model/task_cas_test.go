...
func TestHasTaskPollingWorkExcludesHistoricalFailuresWithoutLedger(t *testing.T) {
	truncateTables(t)
	...
	assert.False(
		t,
		HasTaskPollingWork(),
		"historical failures without a durable ledger require explicit retry or manual reconciliation",
	)
}
