...
func formatUserLogs(logs []*Log, startIdx int) {
	...
	for i := range logs {
		...
		if otherMap != nil {
			...
			delete(otherMap, "opencode_go_affinity_source")
			delete(otherMap, "opencode_go_workspace_uid")
			delete(otherMap, "opencode_go_affinity_key")
...
func RecordConsumeLog(c *gin.Context, userId int, params RecordConsumeLogParams) {
	...
	logger.LogInfo(c, fmt.Sprintf(
		"record consume log: userId=%d, channelId=%d, modelName=%q, promptTokens=%d, completionTokens=%d, quota=%d, tokenId=%d, useTimeSeconds=%d, stream=%t, group=%q",
		userId,
		params.ChannelId,
		params.ModelName,
		params.PromptTokens,
