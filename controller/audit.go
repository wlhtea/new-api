...
var auditContentTemplates = map[string]string{
	...
	"channel.opencode_go_non_member_delete":   "Deleted ${deleted} non-member OpenCode Go workspaces from channel (ID: ${id})",
	"channel.opencode_go_refresh_all":         "Started OpenCode Go refresh task ${task_id} for channel (ID: ${id}, created=${created})",
	"channel.opencode_go_risk_recheck":        "Rechecked risk for OpenCode Go workspace ${workspace_uid} in channel (ID: ${id}, status=${status}, upstream=${upstream_status})",
	"channel.opencode_go_risk_recheck_all":    "Started OpenCode Go risk recheck task ${task_id} for channel (ID: ${id}, created=${created})",
	"channel.opencode_go_lifecycle_policy":    "Updated OpenCode Go lifecycle policy for channel (ID: ${id})",
	"channel.opencode_go_china_models_enable": "Enabled China-deployed models for OpenCode Go workspace ${workspace_uid} in channel (ID: ${id}, operation=${operation_uid}, status=${status})",
	"channel.opencode_go_referral_apply":      "Applied ${applied} of ${attempted} OpenCode Go referral rewards for workspace ${workspace_uid} in channel (ID: ${id})",
	"channel.opencode_go_renewal_cancel":      "Cancelled renewal for OpenCode Go workspace ${workspace_uid} in channel (ID: ${id}, operation=${operation_uid}, period_end=${current_period_end})",
