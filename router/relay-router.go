...
func SetRelayRouter(router *gin.Engine) {
	...
	router.Use(middleware.EncodedRequestAdmissionMiddleware())
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.DecompressRequestMiddleware(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.DecompressRequestMiddleware())
	{
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.DecompressRequestMiddleware(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.DecompressRequestMiddleware())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.DecompressRequestMiddleware(), middleware.Distribute())
	{
