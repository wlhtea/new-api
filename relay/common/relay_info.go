...
type RelayInfo struct {
	...
	// UpstreamRequestBodySize records the final outbound body size for
	// privacy-safe provider diagnostics and custom task adaptors. Shared relay
	// requests derive it from http.Request.ContentLength after applying
	// replayable-body metadata; it is not used to drive transport retries.
