...
func TestClaudeHandlerOmitsOpenCodeErrorBodyFromDebugLog(t *testing.T) {
	...
	body := `{"type":"error","error":{"type":"upstream_error","message":"Authorization: Bearer private-key; x-api-key=private-api-key; endpoint=http://internal-control.local/v1/private"}}`
